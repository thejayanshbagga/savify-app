...
//                             })}
//                         >
//                             <Text style={styles.redeemText}>Large Caramel Frappucino</Text>
//                             <Text style={styles.redeemText}>Ends on November 31st, 2025</Text>
//                             <Text style={styles.redeemText}>Claim Voucher</Text>
//                         </TouchableOpacity>
//                         <TouchableOpacity
//                             style={styles.redeemButton}
//                             onPress={() => navigation.navigate('Redeem', {
...
//                             })}
//                         >
//                             <Text style={styles.redeemText}>Strive Chocolate</Text>
//                             <Text style={styles.redeemText}>Ends on January 21st, 2025</Text>
//                             <Text style={styles.redeemText}>Claim Voucher</Text>
//                         </TouchableOpacity>
//                     </BackgroundBlob>
//                 </View>
